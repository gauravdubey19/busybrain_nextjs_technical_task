...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 font-[family-name:var(--font-geist-sans)] cursor-pointer select-none whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:translate-y-0.5 disabled:cursor-not-allowed disabled:active:translate-y-0 disabled:pointer-events-non disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
